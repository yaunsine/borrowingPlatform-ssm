    ...
    <div class="col-lg-3 col-lg-offset-4 jumbotron" id="login-info">
        ...
        <div v-show="islogin">
            <form class="form" role="form" id="loginform">
                ...
                <div class="row">
                    <div class="btn-group">
                        <input type="text" v-bind:value="type" name="sf" v-show="false" class="form-control">
...
<%--                        id="sizing-addon1"--%>
                        ...
                        <input type="password" name="password" v-model="pwd" class="form-control" placeholder="请输入密码">
                ...
                <div class="row">
                    <div class="input-group ">
                        ...
                        <input type="password" name="repassword" v-model="repwd" class="form-control" placeholder="请再次输入密码">
            ...
            <div class="row">
                <input type="button" value="注册" class="btn btn-success btn-block" @click="register">
            </div><br>
        </div>
    </div>
</div>
        ...
        methods:{
            ...
            register:function () {
                if(this.pwd!=this.repwd){
                    ...
                    $("#registerform").attr("action","${pageContext.request.contextPath}/readerController/register");
