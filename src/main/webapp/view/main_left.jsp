...
<div id="app">
    ...
    <ul class="nav nav-pills nav-stacked ">
        <li role="presentation" class="active table-bordered"><a href="javascript:;" v-on:click="showBook">图书管理</a></li>
        ...
        <li role="presentation" v-show="isUpdateBook"><a href="showbook.jsp" target="right">查看图书</a></li>

    </ul>
    <ul class="nav nav-pills nav-stacked">
        <li role="presentation" class="active table-bordered"><a href="javascript:;" @click="showRentBook">借出图书管理</a></li>

        <li role="presentation" v-show="isShowRent"><a href="${pageContext.request.contextPath}/adminController/overDueRentingBook" target="right">待还图书</a></li>
        <li role="presentation" v-show="isShowRent"><a href="${pageContext.request.contextPath}/adminController/RentedBook" target="right">借出图书历史</a></li>
        <li role="presentation" v-show="isShowRent"><a href="${pageContext.request.contextPath}/adminController/returnHistory" target="right">已还历史</a></li>
    </ul>
    <ul class="nav nav-pills nav-stacked">
